...
export const metersAPI = {
  ...
  bulkAssign: (meterIds, userId) => 
    api.post('/api/meters/bulk-assign', { meter_ids: meterIds, user_id: userId }),
  unassign: (meterIds) => 
    api.post('/api/meters/unassign', { meter_ids: meterIds }),
};
...
export const usersAPI = {
  listTechnicians: () => api.get('/api/users/technicians'),
